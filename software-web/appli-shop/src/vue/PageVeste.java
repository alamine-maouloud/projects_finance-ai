...
public class PageVeste extends JFrame {

    public PageVeste() {
        setTitle("Vestes - Boutique");
        ...
        String[] images = {
                "veste1.png", "veste2.png", "veste3.png",
                "veste4.png", "veste5.png", "veste6.png",
                "veste7.png", "veste8.png", "veste9.png"
        };

        String[] noms = {
                "Veste Ovalo", "Veste Norma", "Veste de-Nîmes Canevas",
                "Veste Giacca", "Veste Tibau", "Veste d'Homme",
                "Veste de-Nîmes Marino", "Veste Ciro", "Veste Ciro Cuir"
        };
        ...
        for (int i = 0; i < images.length; i += 3) {
            ...
            for (int j = i; j < i + 3 && j < images.length; j++) {
                ...
                try {
                    ImageIcon icon = new ImageIcon("veste" + (j + 1) + ".png");
