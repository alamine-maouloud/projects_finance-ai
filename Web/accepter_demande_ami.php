...
if (!isset($_SESSION['id_utilisateur'])) {
    echo "Vous devez être connecté pour accepter une demande.";
    exit;
}
...
$stmt = $pdo->prepare("UPDATE connexions SET statut_connexion = 'acceptée' WHERE id_utilisateur1 = :id_utilisateur1 AND id_utilisateur2 = :id_utilisateur2");
$stmt->execute(['id_utilisateur1' => $id_utilisateur1, 'id_utilisateur2' => $id_utilisateur2]);


$conversationsQuery = $pdo->prepare("INSERT INTO conversations (id_utilisateur1, id_utilisateur2) VALUES (:id_utilisateur1, :id_utilisateur2)");
$conversationsQuery->execute(['id_utilisateur1' => $id_utilisateur1, 'id_utilisateur2' => $id_utilisateur2]);
